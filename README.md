...
You can install the released version of regexcitewangtw from
[CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("regexcitewangtw")
```
...
devtools::install_github("Davidwang11/regexcitewangtw")
```
